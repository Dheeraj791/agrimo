...
@Component({
  ...
  templateUrl: './unitmeasurementmaster.component.html',
  styleUrls: ['./unitmeasurementmaster.component.scss']
})
export class UnitmeasurementmasterComponent implements OnInit {
  ...
  activityType = 'unitmeasurementmaster';
  singleActivity: any;
