...
@Component({
  selector: 'app-mulchmaster',
  templateUrl: './mulchmaster.component.html',
  styleUrls: ['./mulchmaster.component.scss']
})
export class MulchmasterComponent implements OnInit {
